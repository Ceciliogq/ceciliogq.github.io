...
To do everything in one command use the function [`deploy-all`](https://github.com/Ceciliogq/dotfiles/blob/main/.bash_aliases). It will ask for the commit message and use the same for the `root` repo and the `_site` repo. 
